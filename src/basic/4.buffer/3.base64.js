...
// const b1 = Buffer.from('5ZC0')
// console.log(b1); // <Buffer 35 5a 43 30>
// console.log(0x35.toString(2), 0x5a.toString(2), 0x43.toString(2), 0x30.toString(2));
...
str += '0123456789+/'
console.log(str[57] + str[25] + str[2] + str[52]);
